...
public class OrderDetails implements Serializable {
    ...
    public OrderDetails(OrderDetailsPK orderDetailsPK, BigDecimal unitPrice, int quantity, double discount) {
        this.orderDetailsPK = orderDetailsPK;
    ...
    public String toString() {
        return "com.entitybeans.OrderDetails[ orderDetailsPK=" + orderDetailsPK + " ]";
    }
